...
public class ThemeListViewAdapter extends BaseAdapter {
    ...
    private List<ThemeBean.StoriesBean> storiesBeens;
    private NetUtils netUtils;
//    private  mBitmapUtils;

    public ThemeListViewAdapter(Context mContext, List<ThemeBean.StoriesBean> storiesBeens){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ThemeBean.StoriesBean storiesBean = storiesBeens.get(position);
        Log.d("EYCK","theme"+storiesBean.getTitle());
